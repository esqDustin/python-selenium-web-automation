...
## TC-Name-XXX: [Test Case Title]
**Test Case Description:** 

**Preconditions:**
- [What needs to be true before test starts]

**Test Data:** [Only include this section if relevant]
- [For external files: Location: `filename`]
- [For inline: Values embedded in test code]
- [For no special data: Omit this section entirely]

**Test Steps:**
1. [enumarate test steps - what actions are needed for the tester]
